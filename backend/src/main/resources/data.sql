insert into test_db.owner (owner_id, name, token)
values (1,'허밍버드','허밍버드token');
insert into test_db.menu (id, created_date, modified_date, name, owner_owner_id)
...
insert into test_db.customer (customer_id, email, name, password, token)
